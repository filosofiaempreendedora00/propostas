...
function VariationCard({
  ...
  return (
    <div className="overflow-hidden rounded-xl border border-line bg-panel">
      <div
        onClick={onToggle}
        className={`flex cursor-pointer select-none items-center gap-3 px-5 py-4 transition hover:bg-panel-2 ${
          open ? "bg-panel-2" : ""
        }`}
      >
        ...
        <input
          ...
          className="min-w-0 flex-1 bg-transparent text-base font-medium text-ink outline-none placeholder:text-ink-mute"
        />
        <button
          type="button"
          onClick={(e) => {
        ...
        <div className="max-w-5xl px-10 py-9">
          <div className="mb-7 flex items-start justify-between gap-4 border-b border-line pb-5">
            <div>
              ...
              <h2 className="mt-0.5 font-display text-3xl font-semibold tracking-tight">
                {activeMeta.label}
              </h2>
