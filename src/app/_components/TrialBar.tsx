...
export default function TrialBar() {
  return (
    <div className="flex shrink-0 flex-wrap items-center justify-center gap-x-4 gap-y-2 bg-accent px-4 py-2 text-bg">
      ...
      <div className="flex items-center gap-2">
        <Link
          href="/planos"
          className="rounded-full bg-bg px-4 py-1.5 text-xs font-semibold text-ink transition hover:opacity-90"
        >
          Ver planos
        </Link>
        <a
          ...
          className="flex items-center gap-1.5 rounded-full border border-bg/30 px-4 py-1.5 text-xs font-semibold text-bg transition hover:bg-bg/10"
        >
          <WhatsAppIcon />
          Falar no WhatsApp
        </a>
