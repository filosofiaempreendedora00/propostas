      ...
      <aside className="form-scroll h-full w-full overflow-y-auto">
        ...
        {ready && (
          <div className="px-3 pb-4">
            <button
              onClick={handleAdd}
              className="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border-2 border-dashed border-accent/45 bg-accent/[0.08] px-4 py-3.5 text-sm font-semibold text-accent transition hover:border-accent hover:bg-accent/[0.15]"
            >
